...
@:jsRequire("crypto", "Verify") extern class Verify extends node.stream.Writable {
	...
	function update(data:ts.AnyOf11<String, js.lib.Uint8Array, js.lib.Uint8ClampedArray, js.lib.Uint16Array, js.lib.Uint32Array, js.lib.Int8Array, js.lib.Int16Array, js.lib.Int32Array, js.lib.Float32Array, js.lib.Float64Array, js.lib.DataView>):Verify;
	...
	function verify(object:ts.AnyOf4<String, Dynamic, global.Buffer, KeyObject>, signature:global.nodejs.ArrayBufferView):Bool;
