...
@:jsRequire("fs") @valueModuleOnly extern class Fs {
	...
	**/
	@:overload(function(path:node.fs.PathLike, options:node.fs.BigIntOptions, callback:(err:Null<global.nodejs.ErrnoException>, stats:node.fs.BigIntStats) -> Void):Void { })
	@:overload(function(path:node.fs.PathLike, options:node.fs.StatOptions, callback:(err:Null<global.nodejs.ErrnoException>, stats:ts.AnyOf2<node.fs.BigIntStats, node.fs.Stats>) -> Void):Void { })
	...
	**/
	@:overload(function(path:node.fs.PathLike, options:node.fs.BigIntOptions):node.fs.BigIntStats { })
	@:overload(function(path:node.fs.PathLike, options:node.fs.StatOptions):ts.AnyOf2<node.fs.BigIntStats, node.fs.Stats> { })
	...
	**/
	@:overload(function(path:node.fs.PathLike, options:node.fs.RmDirAsyncOptions, callback:node.fs.NoParamCallback):Void { })
	...
	**/
	@:overload(function(fd:Float, buffers:Array<global.nodejs.ArrayBufferView>, position:Float, cb:(err:Null<global.nodejs.ErrnoException>, bytesWritten:Float, buffers:Array<global.nodejs.ArrayBufferView>) -> Void):Void { })
	static function writev(fd:Float, buffers:Array<global.nodejs.ArrayBufferView>, cb:(err:Null<global.nodejs.ErrnoException>, bytesWritten:Float, buffers:Array<global.nodejs.ArrayBufferView>) -> Void):Void;
	/**
		See `writev`.
	**/
	static function writevSync(fd:Float, buffers:Array<global.nodejs.ArrayBufferView>, ?position:Float):Float;
	@:overload(function(fd:Float, buffers:Array<global.nodejs.ArrayBufferView>, position:Float, cb:(err:Null<global.nodejs.ErrnoException>, bytesRead:Float, buffers:Array<global.nodejs.ArrayBufferView>) -> Void):Void { })
	static function readv(fd:Float, buffers:Array<global.nodejs.ArrayBufferView>, cb:(err:Null<global.nodejs.ErrnoException>, bytesRead:Float, buffers:Array<global.nodejs.ArrayBufferView>) -> Void):Void;
	/**
		See `readv`.
	**/
	static function readvSync(fd:Float, buffers:Array<global.nodejs.ArrayBufferView>, ?position:Float):Float;
