...
typedef FileHandle = {
	...
	**/
	function writev(buffers:Array<global.nodejs.ArrayBufferView>, ?position:Float):js.lib.Promise<node.fs.WriteVResult>;
	/**
		See `fs.readv` promisified version.
	**/
	function readv(buffers:Array<global.nodejs.ArrayBufferView>, ?position:Float):js.lib.Promise<node.fs.ReadVResult>;
	/**
