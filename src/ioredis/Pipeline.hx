...
typedef Pipeline = {
	...
	function hset(key:KeyType, field:String, value:ValueType_, ?callback:Callback<BooleanResponse>):Pipeline;
	...
	function sscan(key:KeyType, cursor:Float, args:haxe.extern.Rest<ValueType_>):Pipeline;
	function hscan(key:KeyType, cursor:Float, args:haxe.extern.Rest<ValueType_>):Pipeline;
	function zscan(key:KeyType, cursor:Float, args:haxe.extern.Rest<ValueType_>):Pipeline;
