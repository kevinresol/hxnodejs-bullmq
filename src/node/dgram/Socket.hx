...
@:jsRequire("dgram", "Socket") extern class Socket extends node.events.EventEmitter {
	...
	@:overload(function(msg:ts.AnyOf3<String, Array<Dynamic>, js.lib.Uint8Array>, ?port:Float, ?callback:(error:Null<js.lib.Error>, bytes:Float) -> Void):Void { })
	@:overload(function(msg:ts.AnyOf3<String, Array<Dynamic>, js.lib.Uint8Array>, ?callback:(error:Null<js.lib.Error>, bytes:Float) -> Void):Void { })
	...
	function send(msg:ts.AnyOf3<String, Array<Dynamic>, js.lib.Uint8Array>, ?port:Float, ?address:String, ?callback:(error:Null<js.lib.Error>, bytes:Float) -> Void):Void;
