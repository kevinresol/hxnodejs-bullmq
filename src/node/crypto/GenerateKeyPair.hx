...
@:jsRequire("crypto", "generateKeyPair") @valueModuleOnly extern class GenerateKeyPair {
	...
	@:overload(function(type:String, options:ED25519KeyPairKeyObjectOptions, callback:(err:Null<js.lib.Error>, publicKey:KeyObject, privateKey:KeyObject) -> Void):Void { })
	@:selfCall
